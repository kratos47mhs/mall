...
public class OmsCartItemController {
    ...
    @ApiOperation("Get a member's shopping cart list")
    ...
    @ApiOperation("Modify the quantity of a product in the shopping cart")
    ...
    @ApiOperation("Get the specifications of a product in the shopping cart for reselection")
    ...
    @ApiOperation("Modify the specifications of the products in the shopping cart")

...
public class OmsOrder implements Serializable {
    ...
    @ApiModelProperty(value = "The total amount of orders")
    private BigDecimal totalAmount;

    @ApiModelProperty(value = "Amount payable (actual payment amount)")
    ...
    @ApiModelProperty(value = "Points deduction amount")
    private BigDecimal integrationAmount;

    @ApiModelProperty(value = "Coupon deduction amount")
    private BigDecimal couponAmount;

    @ApiModelProperty(value = "The administrator adjusts the discount amount used by the order in the back-end")
    private BigDecimal discountAmount;

    @ApiModelProperty(value = "Payment methods: 0-> not paid; 1-> Alipay; 2-> WeChat")
    ...
    @ApiModelProperty(value = "Logistics company (distribution method)")
    private String deliveryCompany;

    @ApiModelProperty(value = "shipment number")
    ...
    @ApiModelProperty(value = "Bill type: 0-> no Bill; 1-> electronic Bill; 2-> paper Bill")
    private Integer billType;

    @ApiModelProperty(value = "Bill")
    ...
    @ApiModelProperty(value = "Recipient's mailbox")
    ...
    @ApiModelProperty(value = "Confirm delivery time")

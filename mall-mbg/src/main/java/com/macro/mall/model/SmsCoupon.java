...
public class SmsCoupon implements Serializable {
    ...
    @ApiModelProperty(value = "Coupon type; 0-> coupon coupons; 1-> member coupons; 2-> shopping coupons; 3-> registered coupons")
    ...
    @ApiModelProperty(value = "Maximum number of sheets per person")
    ...
    @ApiModelProperty(value = "Use type: 0-> common for all audiences; 1-> designated Category; 2-> designated Product")
    ...
    @ApiModelProperty(value = "Number received")
    private Integer receiveCount;

    @ApiModelProperty(value = "Available dates")
    private Date enableTime;

    @ApiModelProperty(value = "Promo Code")
    private String code;

    @ApiModelProperty(value = "Available member types: 0-> infinite time")

 ...
 */
@Controller
@Api(tags = "SmsHomeAdvertiseController", description = "Homepage Advertise management")
...
public class SmsHomeAdvertiseController {
    ...
    @ApiOperation("Pagination query ads")

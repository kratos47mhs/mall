...
public class PmsProductCategoryController {
    ...
    @ApiOperation("Get product categories based on id")
    ...
    @ApiOperation("Modify the display status of the navigation bar")
    ...
    @ApiOperation("Query all first-level categories and subcategories")

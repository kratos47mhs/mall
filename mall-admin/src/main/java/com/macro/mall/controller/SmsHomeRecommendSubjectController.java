...
/**
 * Home Recommend Subject Management Controller
...
public class SmsHomeRecommendSubjectController {
    ...
    @ApiOperation("Add a featured topic on the homepage")
    ...
    @ApiOperation("Modify recommendation ranking")
    ...
    @ApiOperation("Delete recommendations in bulk")
    ...
    @ApiOperation("Bulk edit recommendation status")
    ...
    @ApiOperation("Paging query recommendation")

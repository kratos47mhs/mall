 ...
 */
@Controller
@Api(tags = "SmsFlashPromotionSessionController", description = "Flash Promotion Session management")
@RequestMapping("/flashSession")
public class SmsFlashPromotionSessionController {
    @Autowired
    private SmsFlashPromotionSessionService flashPromotionSessionService;

    @ApiOperation("Add sessions")
    ...
    @ApiOperation("Modify activation status")
    ...
    @ApiOperation("Get all available sessions and their number")

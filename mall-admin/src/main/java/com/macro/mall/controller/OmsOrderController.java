...
public class OmsOrderController {
    ...
    @ApiOperation("Get order details: order information, product information, operation records")
    ...
    @ApiOperation("Modify Receiver information")

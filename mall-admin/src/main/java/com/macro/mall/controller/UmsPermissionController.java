 ...
 */
@Controller
@Api(tags = "UmsPermissionController", description = "Background Permission management")
...
public class UmsPermissionController {
    ...
    @ApiOperation("Return all permissions in a hierarchical structure")
    ...
    @ApiOperation("Get all permission lists")

...
/**
 * Commodity attribute classification
...
public class PmsProductAttributeCategoryController {
    ...
    @ApiOperation("Delete a single product attribute classification")
    ...
    @ApiOperation("Get all product attribute classifications by page")
    ...
    @ApiOperation("Get all product attribute categories and their attributes")
